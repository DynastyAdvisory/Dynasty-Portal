...
export default async function AuditLogPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <h1 className="text-lg font-semibold text-gray-900 mb-6">Audit Log</h1>
            ...
            <div key={log.id} className="px-5 py-3 flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm text-gray-800">
                  <span className="font-medium">{profileMap[log.profileId] ?? log.profileId}</span>
                  {log.clientId && <span className="text-gray-500"> · {clientMap[log.clientId] ?? log.clientId}</span>}
